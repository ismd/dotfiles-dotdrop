...
*** Load Theme
#+begin_src emacs-lisp
(defvar theme-name 'doom-ephemeral "The name of the theme to use")
...
(use-package copilot-chat
  ...
  (copilot-chat-default-model "gemini-2.0-flash-001")
...
(setq ismd/font-family "CodeNewRoman Nerd Font Mono-14"
      ismd/font-size 140)
{%@@ else @@%}
(setq ismd/font-family "CodeNewRoman Nerd Font Mono-15"
      ismd/font-size 150)
{%@@ endif @@%}
