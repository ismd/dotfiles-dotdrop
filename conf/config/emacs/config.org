...
(use-package general
  ...
  (general-define-key
   ...
   "C-1" '(winum-select-window-1 :wk "Select window 1")
   "C-2" '(winum-select-window-2 :wk "Select window 2")
   "C-3" '(winum-select-window-3 :wk "Select window 3")
   "C-4" '(winum-select-window-4 :wk "Select window 4")
   "C-5" '(winum-select-window-5 :wk "Select window 5")
   "C-6" '(winum-select-window-6 :wk "Select window 6")
   "C-7" '(winum-select-window-7 :wk "Select window 7")
   "C-8" '(winum-select-window-8 :wk "Select window 8")
   "C-9" '(winum-select-window-9 :wk "Select window 9")   
   ...
   "M-1" '((lambda () (interactive) (tab-bar-select-tab 1)) :wk "Select tab 1")
   "M-2" '((lambda () (interactive) (tab-bar-select-tab 2)) :wk "Select tab 2")
   "M-3" '((lambda () (interactive) (tab-bar-select-tab 3)) :wk "Select tab 3")
   "M-4" '((lambda () (interactive) (tab-bar-select-tab 4)) :wk "Select tab 4")
   "M-5" '((lambda () (interactive) (tab-bar-select-tab 5)) :wk "Select tab 5")
   "M-6" '((lambda () (interactive) (tab-bar-select-tab 6)) :wk "Select tab 6")
   "M-7" '((lambda () (interactive) (tab-bar-select-tab 7)) :wk "Select tab 7")
   "M-8" '((lambda () (interactive) (tab-bar-select-tab 8)) :wk "Select tab 8")
   "M-9" '((lambda () (interactive) (tab-bar-select-tab 9)) :wk "Select tab 9")
  ...
  (cz/leader-keys
    ...
    "f m" '(rename-visiting-file :wk "Rename file")
