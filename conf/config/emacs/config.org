...
(use-package gptel
  :config
  (setq-default gptel-model "wizardcoder:latest"
  ...
  (add-to-list 'gptel-directives '(commit . "I want you to act as a commit message generator. I will provide you with a git diff, and I would like you to generate an appropriate commit message using the conventional commit format. Do not write any explanations or other words, just reply with the commit message.")))
#+end_src
