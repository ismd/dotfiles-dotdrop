...
#+begin_src emacs-lisp
(defvar theme-name 'ef-light "The name of the theme to use")
...
(use-package copilot-chat
  ...
  :config
  (copilot-chat-set-model "claude-3.7-sonnet-thought"))
#+end_src
...
(use-package general
  ...
  (general-define-key
   ...
   "C-M-n" '(ibuffer-forward-filter-group :wk "Next filter group")
   "C-M-p" '(ibuffer-backward-filter-group :wk "Previous filter group"))
  ...
  (general-define-key
   ...
   "M-n" nil
   "M-p" nil
   "C-M-n" '(markdown-outline-next :wk "Next heading")
   "C-M-p" '(markdown-outline-previous :wk "Previous heading"))
  ...
  (general-define-key
   ...
   "C-M-n" '(org-next-visible-heading :wk "Next heading")
   "C-M-p" '(org-previous-visible-heading :wk "Previous heading"))
