...
- [[#tree-sitter][TREE SITTER]]
  ...
  - [[#tree-sitter-auto][Tree Sitter Auto]]
  - [[#ts-fold][Ts Fold]]
- [[#treemacs][TREEMACS]]
- [[#vertico][VERTICO]]
  - [[#orderless][Orderless]]
...
TODO Compilation https://github.com/minad/consult?tab=readme-ov-file#compilation
...
(use-package general
  ...
  (cz/leader-keys
    ...
    "f d" '(delete-file :wk "Delete this file") ;; TODO Need to delete ~this~ file
  ...
  ;; TODO Consult help https://github.com/minad/consult?tab=readme-ov-file#help
  (cz/leader-keys
    "h" '(:ignore t :wk "Help")
  ...
  ;; TODO Grep and find https://github.com/minad/consult#grep-and-find
  (cz/leader-keys
    "s" '(:ignore t :wk "Search")
    "s d" '(find-grep-dired :wk "Search for string in files in DIR")
  ...
  (cz/leader-keys
    ...
    "C-f C-f" '(ts-fold-toggle :wk "Toggle fold")
    "C-f F" '(ts-fold-close-all :wk "Fold all")
    "C-f U" '(ts-fold-open-all :wk "Unfold all"))
...
I use =consult= instead of =counsel=.
