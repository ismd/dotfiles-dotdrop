...
;; (add-hook 'elpaca-after-init-hook (lambda () (load-theme 'tsdh-light t)))
;; (add-hook 'elpaca-after-init-hook (lambda () (load-theme 'doom-opera-light t)))
;; (add-hook 'elpaca-after-init-hook (lambda () (load-theme 'doom-tomorrow-day t)))
...
(add-hook 'after-make-frame-functions (lambda () (cz/set-fonts)))
