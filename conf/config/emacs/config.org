...
(use-package copilot-chat
  ...
  (defvar ismd/copilot-chat-commit-prompt nil "The commit prompt for Copilot Chat.")
  (when (file-exists-p "~/.config/emacs/commit-prompt.el")
    (load-file "~/.config/emacs/commit-prompt.el"))

  (when ismd/copilot-chat-commit-prompt
    (setq copilot-chat-commit-prompt ismd/copilot-chat-commit-prompt))
...
(setq ismd/font-family "CodeNewRoman Nerd Font Mono-13"
      ismd/font-size 130)
{%@@ else @@%}
