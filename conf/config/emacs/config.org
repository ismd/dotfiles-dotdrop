...
(use-package general
  ...
  (general-define-key
   ...
   ;; Scroll
   "<prior>" '(good-scroll-up-full-screen :wk "Scroll up full screen")
   "<next>" '(good-scroll-down-full-screen :wk "Scroll down full screen")
   "M-v" '(good-scroll-up-full-screen :wk "Scroll up full screen")
   "C-v" '(good-scroll-down-full-screen :wk "Scroll down full screen")
